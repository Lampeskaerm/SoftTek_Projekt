...
public class Ghost extends Objects{
	boolean pacdot = false, superdot = false, fruit = false, hit = false;
	...
	public void Movements(){
		...
		//move right.
			if(Array[pos.x][pos.y].equals(ghostColor+"Ghost")){
				if(ghost.equals("right")){
					if(pos.x < Width - 1){
						getLocation();
						pacman.getLocation();
						if(Array[pos.x + 1][pos.y].equals("pacDot")){
						...
						}else if(Array[pos.x + 1][pos.y].equals("fruit")){
							Array[pos.x + 1][pos.y] = ghostColor+"Ghost";
							if(pacdot)
								Array[pos.x][pos.y] = "pacDot";
							else if(superdot)
						...
						}else if(Array[pos.x + 1][pos.y].equals("bigPacDot")){
							Array[pos.x + 1][pos.y] = ghostColor+"Ghost";
							if(pacdot)
								Array[pos.x][pos.y] = "pacDot";
							else if(superdot)
...
//	                        ghost = "left"; 
							...
							if(!Model.godMode){
								...
								Pacman.pacmanSounds("pacman_eatghost.wav");
								if(pacdot)
									Array[pos.x][pos.y] = "pacDot";
								else if(superdot)
									Array[pos.x][pos.y] = "bigPacDot";
...
//	                        ghost = "left"; 
				...
				if(ghost.equals("up")){
					if(pos.y > 0){
						getLocation();
						pacman.getLocation();
						if(Array[pos.x][pos.y - 1].equals("pacDot")){
							Array[pos.x][pos.y - 1] = ghostColor+"Ghost";
							if(pacdot)
								Array[pos.x][pos.y] = "pacDot";
							else if(superdot)
						...
						}else if(Array[pos.x][pos.y - 1].equals("fruit")){
							Array[pos.x][pos.y - 1] = ghostColor+"Ghost";
							if(pacdot)
								Array[pos.x][pos.y] = "pacDot";
							else if(superdot)
						...
						}else if(Array[pos.x][pos.y - 1].equals("bigPacDot")){
							Array[pos.x][pos.y - 1] = ghostColor+"Ghost";
							if(pacdot)
								Array[pos.x][pos.y] = "pacDot";
							else if(superdot)
						...
						}else if(Array[pos.x][pos.y - 1].equals("portal")){ 
	                        Array[1][14] = ghostColor + "Ghost"; 
	                        Array[25][14] = "blackSpace"; 
	                        setAllFalse();
...
//	                        ghost = "left"; 
	                    ...
	                    }else if(Array[pos.x][pos.y - 1].equals("pacMan")){
							if(!Model.godMode){
								Pacman.pacmanSounds("pacman_death.wav");
								Pacman.lives--;
								Array[13][23] = "pacMan";
...
//	                        ghost = "left"; 
	...
	public void checkIllegalPos(){
		...
		if(illegalPos.size() < 3 && !illegalPos.contains(lastPos))
