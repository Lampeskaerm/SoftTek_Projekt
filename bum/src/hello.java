	...
	public void getLocation(){
		for(int i = 0; i < Width; i++){
			for(int j = 0; j < Height; j++){
				if(Array[i][j].equals(ghostColor + "Ghost") || Array[i][j].equals(ghostColor+"Ghost") || Array[i][j].equals(ghostColor+"Ghost")){
					pos.x = i;
					pos.y = j;
				}
			}
		...
		//move right.
				if(ghost.equals("right")){
					if(pos.x < Width - 1){
						...
						}else if(Array[pos.x][pos.y].equals(ghostColor+"Ghost") && Array[pos.x + 1][pos.y].equals("pacDot")){
							Array[pos.x + 1][pos.y] = ghostColor+"Ghost";
							Array[pos.x][pos.y] = "blackSpace";
				...
				if(ghost.equals("up")){
					if(pos.y > 0){
						...
						}else if(Array[pos.x][pos.y].equals(ghostColor+"Ghost") && Array[pos.x][pos.y - 1].equals("pacDot")){
							Array[pos.x][pos.y - 1] = ghostColor+"Ghost";
							Array[pos.x][pos.y] = "blackSpace";
