...
public class Ghost extends Objects{
	...
	public void checkIllegalPos(){
		getLocation();
		if(Array[pos.x + 1][pos.y].endsWith("Wall") || Array[pos.x + 1][pos.y].startsWith("cyan") || Array[pos.x + 1][pos.y].startsWith("red") || Array[pos.x + 1][pos.y].startsWith("orange") || Array[pos.x + 1][pos.y].startsWith("pink")){		
